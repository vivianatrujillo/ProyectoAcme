...
import com.Acme.ssesion.PacienteFacade;
...
public class PacienteController implements Serializable {
    ...
    @EJB
    private com.Acme.ssesion.PacienteFacade ejbFacade;
    ...
    public String create() {
     ...
     public String prepareCrear1() {
        current = new Paciente();
        selectedItemIndex = -1;
        return "LISTA";
    }
     
      public String crear1() {
        try {
            getFacade().create(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PacienteCreated"));
            return prepareCrear1();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
        }
